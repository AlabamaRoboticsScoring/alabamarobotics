...
RSpec.describe AttemptsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all attempts as @attempts" do
      ...
      expect(assigns(:attempts)).to eq([attempt])
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created attempt as @attempt" do
        post :create, {:attempt => valid_attributes}, valid_session
        expect(assigns(:attempt)).to be_a(Attempt)
        expect(assigns(:attempt)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved attempt as @attempt" do
        post :create, {:attempt => invalid_attributes}, valid_session
        expect(assigns(:attempt)).to be_a_new(Attempt)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested attempt" do
        attempt = Attempt.create! valid_attributes
        put :update, {:id => attempt.to_param, :attempt => new_attributes}, valid_session
        attempt.reload
    ...
    context "with invalid params" do
      it "assigns the attempt as @attempt" do
        attempt = Attempt.create! valid_attributes
        put :update, {:id => attempt.to_param, :attempt => invalid_attributes}, valid_session
        expect(assigns(:attempt)).to eq(attempt)
      end
